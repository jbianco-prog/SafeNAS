...
This project is licensed under the GPL License - see the [LICENSE]([LICENSE.md](https://github.com/jbianco-prog/SafeNAS/blob/master/LICENSE_GPL.md)) file for details.
